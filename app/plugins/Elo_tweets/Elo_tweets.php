...
<div id="Twitter">
    <?php
        $cache='../app/plugins/Elo_tweets/cache.tmp'; //Definition "cache" folder
        ...
        <ul>
            <?php foreach ($tweet as $key => $value) { ?>
                    ...
                    //---------------------------------------------------
                    $hour = $hour + 1; //your time's location (0 = UTF) Example : Paris = UTF+1// define jet lag
                    //---------------------------------------------------
